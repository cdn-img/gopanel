...
cp -af csf/csf_small.png /usr/local/cpanel/whostmgr/docroot/addon_plugins/
...
cp -avf cpanel/csfalt.tmpl /usr/local/cpanel/whostmgr/docroot/templates/
#cp -avf cpanel/csf.tmpl /usr/local/cpanel/whostmgr/docroot/templates/
#cp -avf cpanel/csfend.tmpl /usr/local/cpanel/whostmgr/docroot/templates/
